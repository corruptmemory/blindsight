...
object ParameterList {
  ...
  def lists(logger: org.slf4j.Logger): Array[ParameterList] = Array(
    new ErrorParameterList(logger),
    new WarnParameterList(logger),
    new InfoParameterList(logger),
    new DebugParameterList(logger),
    new TraceParameterList(logger)
  )
}
...
class TraceParameterList(logger: org.slf4j.Logger) extends ParameterList(Level.TRACE, logger) {
...
class DebugParameterList(logger: org.slf4j.Logger) extends ParameterList(Level.DEBUG, logger) {
...
class InfoParameterList(logger: org.slf4j.Logger) extends ParameterList(Level.INFO, logger) {
...
class WarnParameterList(logger: org.slf4j.Logger) extends ParameterList(Level.WARN, logger) {
...
class ErrorParameterList(logger: org.slf4j.Logger) extends ParameterList(Level.ERROR, logger) {
